...
\author{\textbf{Laboratorio di Reinforcement Learning Avanzato} \\
Corso di Laurea Magistrale in Informatica e Intelligenza Artificiale \\
...
Il presente capitolo risponde formalmente a quattro domande di ricerca ($RQ_1$--$RQ_4$):
\begin{enumerate}
