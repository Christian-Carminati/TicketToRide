"""Baseline Benchmark Script for TicketToRide RL Lab."""

import time
import numpy as np
import torch

from src.game.maps import load_usa_board, create_synthetic_mini_board
...
def run_all_benchmarks():
    results = {}
    print("=" * 60)
    print("STARTING BASELINE SCIENTIFIC BENCHMARK")
    print("=" * 60)

    # 1. Pure Game Core: 200 full games (Greedy vs Strategic)
    ...
    print("Saved results to benchmark_baseline.json")
